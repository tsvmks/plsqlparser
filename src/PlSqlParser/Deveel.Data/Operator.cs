...
namespace Deveel.Data {
	...
	public abstract class Operator {
		...
		/// two <see cref="DataObject"/> passed as parameters.
		/// </summary>
		...
		/// <summary>
		/// Returns true if the given DataObject is a bool and is true.  If the
		/// DataObject is not a bool value or is null or is false, then it returns
		/// false.
		/// </summary>
		/// <param name="b"></param>
		/// <returns></returns>
