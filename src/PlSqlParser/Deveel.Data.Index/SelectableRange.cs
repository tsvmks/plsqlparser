...
namespace Deveel.Data.Index {
	...
	public sealed class SelectableRange {
		...
		/// </remarks>
		public static readonly DataObject FirstInSet = new DataObject(PrimitiveTypes.Null(), "[FIRST_IN_SET]");
		...
		/// Note that these objects have no (NULL) type.
		/// </remarks>
		public static readonly DataObject LastInSet = new DataObject(PrimitiveTypes.Null(), "[LAST_IN_SET]");
		...
		/// </summary>
		public static readonly SelectableRange FullRangeNoNulls = new SelectableRange(RangePosition.AfterLastValue, DataObject.Null,
		                                                                              RangePosition.LastValue, LastInSet);
		...
		/// </remarks>
		public DataObject Start { get; private set; }
		...
		/// This may return <see cref="FirstInSet"/> or  <see cref="LastInSet"/>.
		/// </remarks>
		public DataObject End { get; private set; }
		...
		/// </remarks>
		public RangePosition StartPosition { get; private set; }
